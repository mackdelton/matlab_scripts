...
for iter_i = iter
    ...
    for ii = v
        ...
        eval(['save(''./data_stationaryB_1/cond_' num2str(kk) 'of' num2str(noN) '/dataout_' num2str(spaceType) '_' num2str(probType) '_' num2str(N) '_' num2str(iter_i) '_' num2str(ii) '.mat'');']);
        waitbar(ii/length(v));
    end
    close(hhh)
